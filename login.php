...
<body>
  ...
  <div class="container-fluid m-0 p-0">
    <div class="row">
      ...
      <div class="col-6 d-none d-lg-block vh-100" style="
      ...
      <div class="col-lg-6 col-12">
        ...
        <div id="signup-form" class="form-container mt-95">
          <form class="min-vh-80 m-10 w-100 rounded-1">
            <div
              class="d-flex flex-column gap-3 mx-auto p-4 min-w-540 sm:min-w-96 border rounded rounded-3 text-muted text-sm shadow-lg">
              ...
              <div class="row">
                ...
                <div class="col-12 col-lg-12">
                  ...
                  <input id="password" class="form-control mt-1" type="password" placeholder="Enter Password"
                    required />
                </div>
              </div>
          ...
          <form class="min-vh-80 m-10 w-100 rounded-1">
            <div
              ...
              <div class="w-100">
                ...
                <a class="secondary-color fw-bold" onclick="forgot();">Forgot password ?</a>
              </div>
      ...
      <div class="modal-content">
        ...
        <div class="modal-body">
          ...
          <div class="mb-3">
            ...
            <input type="text" class="form-control" id="verificationCode" placeholder="Enter your verification code"
              required>
          </div>
          <div class="mb-3">
        ...
        <div class="modal-footer">
          <button type="button" class="btn primary-secondary rounded-0" data-bs-dismiss="modal">Close</button>
          <p class="theme-btn style-two" onclick="confirmPasswordDetails()">Confirm Details</p>
        </div>
      </div>
    </div>
  </div>
