...
=======
        <section class="shopping-cart-area py-130 rel z-1">
                        ...
                        <table>
                            ...
                            <tbody>
                                ...
                                if ($cart_rs->num_rows > 0) {
                                    for ($x = 0; $x < $cart_rs->num_rows; $x++) {
                                        ...
                                        <tr id="cartRow<?php echo $x; ?>">
                                            ...
                                            <td><span class="title"><?php echo $cart_d["product_name"]; ?>
                                                    <?php echo $cart_d["box_type_name"]; ?>
                                                    (<?php echo $cart_d["preference_name"]; ?>)</span></td>
                                            <td><span class="price"><?php echo $cart_d["price"]; ?></span></td>
                                            <td>
                                                <div class="quantity-input">
                                                    <button class="quantity-down">--</button>
                                                    <input class="quantity" type="text" value="<?php echo $cart_d["cart_qty"]; ?>"
                                                        name="quantity">
                                    ...
                                    $discount = 100; // for example only use this func. param harindu aiye me variable name ekama dala calculate karanna 
                                } else {
                    ...
                    <div class="row text-center text-lg-left align-items-center">
                        ...
                        <div class="col-lg-6">
                            <div class="update-shopping mb-30 text-lg-end wow fadeInRight delay-0-2s">
                                <a href="shop.html" class="theme-btn style-two my-5">shopping <i
                                        class="fas fa-angle-double-right"></i></a>
                                <a href="shop.html" class="theme-btn my-5">update cart <i
                                        class="fas fa-angle-double-right"></i></a>
                        ...
                        <div class="col-lg-8">
                            <div class="shoping-cart-total pt-20 wow fadeInUp delay-0-2s">
                                ...
                                if ($address_rs->num_rows > 0) {
                                    ...
                                    echo $address;
                                    ?>
                                    <a onclick="payout(number_format($subTotal, 2),$user_email,number_format($discount, 2),number_format($shipFee, 2));"
                                        class="theme-btn style-two mt-25 w-100">Proceed to checkout</a>
                                    <?php
                                } else {
                                    ?>
                                    <div class="text-center my-100">
                                        <a>
                                            <div class="theme-btn" onclick="<?php echo $payout ?>">
                                                You need to have your address set in your profile</div>
                                        </a>
            ...
            ?>
>>>>>>> af04e1bc22adbfc6f59d5a40f39db29400bc7add
        </section>
        <!-- Shopping Cart Area start -->
